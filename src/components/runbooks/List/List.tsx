...
const NoteSidebar = forwardRef((props: NotesSidebarProps, ref: React.ForwardedRef<ListApi>) => {
  ...
  return (
    <div
      className={cn([
        "relative h-full bg-gray-100/90 dark:bg-zinc-800/90 backdrop-blur-2xl backdrop-saturate-150 border-r border-gray-200/50 dark:border-zinc-700/50 select-none flex flex-col",
      ])}
      style={{
        width: "100%",
        height: "100%",
