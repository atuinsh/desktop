...
use crate::{
    ...
    context::{
        BlockWithContext, DocumentCwd, DocumentEnvVar, DocumentEnvVars, DocumentSshHost,
        DocumentVar, DocumentVars,
    },
};
...
impl ContextResolver {
    ...
    pub fn from_blocks_with_parent(blocks: &[BlockWithContext], parent: &ContextResolver) -> Self {
